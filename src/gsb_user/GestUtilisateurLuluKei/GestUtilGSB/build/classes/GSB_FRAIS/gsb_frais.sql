...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 21 nov. 2023 à 14:37
...
(1, 'le buhe', 'tanguy', 't.lebuhe', '1595'),
(2, 'nicolas', 'mathis', 'm.nicolas', '1234');
...
INSERT INTO `utilisateurs` (`id`, `nom`, `prenom`, `login`, `mdp`, `adresse`, `cp`, `ville`, `dateEmbauche`) VALUES
...
('b16', 'Bioret', 'mathis', 'lbioret', 'hrjfs', '1 Avenue gambetta', '46000', 'Cahors', '1998-05-11'),
...
('f5', 'Sakina', 'Zanati', 'zsakina', 'OUmbtugM', 'Rue de Chaptal', '29000', 'Quimper', '1978-12-18');
